    ...
    <div class="modal-content">
      ...
      <div class="modal-body p-0">
        <div class="row g-0">
          ...
          <div class="col-md-7">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.426543160408!2d80.24581451528612!3d12.97232239085521!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a525d6b4d3f3f3f%3A0x8e8b2b6b2b6b2b6b!2sSynergech%20Technology%20Solutions!5e0!3m2!1sen!2sin!4v1628154124357!5m2!1sen!2sin" width="100%" height="100%" style="border:0; min-height: 400px;" allowfullscreen="" loading="lazy"></iframe>
          </div>
        </div>
      </div>
    </div>
...
if (!h.includes('id="contactModal"')) {
  // Inject the modals just before the loader script
  h = h.replace('<script>\ndocument.addEventListener', modalsHTML + '\n<script>\ndocument.addEventListener');
}

// Update the links in footer to open the modals
h = h.replace('<li><a href="#">Contact Us</a></li>', '<li><a href="#" data-bs-toggle="modal" data-bs-target="#contactModal">Contact Us</a></li>');
h = h.replace('<li><a href="#">Our Story</a></li>', '<li><a href="#" data-bs-toggle="modal" data-bs-target="#aboutModal">Our Story</a></li>');
